package it.androidavanzato.fragmentnavigationdrawer;
...
public class MainActivity extends ActionBarActivity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private static int fragmentSequence = 1;
        private int fragmentNumber = fragmentSequence++;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            text.setText("Section " + fragmentNumber + "/" + getSectionNumber());
            return rootView;
        }
        ...
        private void log(String s) {
            Log.d("FRAGMENTS", s + " " + fragmentNumber + "/" + getSectionNumber());
        }
